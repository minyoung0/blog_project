...
$(document).ready(function(){
    ...
    $('#submitButton').click(function () {
        ...
        const subCodeName = $('#subCodeName').val();
        const subCodeDescription = $('#subCodeDescription').val();
    	var deleteYn = $("input[type='radio']:checked").val();

        console.log(mainCodeId);
        console.log(subCodeName);
        console.log(subCodeDescription);
        console.log(deleteYn);
        console.log(typeof deleteYn);
        
        // 유효성 검사
        if (!mainCodeId.trim()) {
            alert('코드ID를 입력해주세요.');
            return;
        }else if(!subCodeName.trim()){
        	  alert('코드명을 입력해주세요.');
              return;
        }else if(!subCodeDescription.trim()){
        ...
        formData.append('subCodeName', subCodeName);
        formData.append('subCodeDescription',subCodeDescription);
		...
		<div class="addMainCodeSection">
			<form method="post" id="addMainCode">
				<div class="codeIdSection">
					<label for="mainCodeId">대문항 코드Id</label> <input type="text" class="form-control" id="mainCodeId" name="mainCodeId" value="${codeDetail.mainCodeId }" disabled />
				</div>
				<div class="codeIdSection">
					<label for="subCodeId">소문항 코드Id</label> <input type="text" class="form-control" id="subCodeId" name="subCodeId" value="${codeDetail.subCodeId }" disabled />
				</div>
				<div class="codeNameSection">
					<label for="subCodeName">코드명</label> <input type="text" class="form-control" id="subCodeName" name="subCodeName" value="${codeDetail.subCodeName}">
				</div>
				<div class="codeDescriptionSection">
					<label for="subCodeDescription">코드상세정보</label> <input type="text" class="form-control" id="subCodeDescription" name="subCodeDescription" value="${codeDetail.subCodeDescription }">
				</div>
