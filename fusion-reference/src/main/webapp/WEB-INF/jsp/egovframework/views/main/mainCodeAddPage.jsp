		...
		if(confirm("추가하시겠습니까?")){
         $.ajax({
            ...
            success: function (response) {
                if (response.success) {
                    alert('새로운 대분류 공통코드 작성이 완료되었습니다!');
            ...
            error: function (err) {
                // 서버 오류 발생 시
                console.error(err);
                displayErrorMessage('게시글 작성 중 오류가 발생했습니다.');
            }
        });
		}
		...
		<div class="addMainCodeSection">
			<form method="post" id="addMainCode">
				<div class="codeIdSection">
					<label for="mainCodeId">코드Id</label> <input type="text" class="form-control" id="mainCodeId" name="boardTitle" value="">
				</div>
				<div class="codeNameSection">
					<label for="mainCodeName">코드명</label> <input type="text" class="form-control" id="mainCodeName" name="boardTitle" value="">
				</div>
				<div class="codeDescriptionSection">
					<label for="mainCodeDescription">코드상세정보</label> <input type="text" class="form-control" id="mainCodeDescription" name="boardTitle" value="">
				</div>
